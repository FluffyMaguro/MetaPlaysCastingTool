...
class ProfileManager:
    ...
    def addProfile(self, name, current=False, default=False, copy='', id=''):
        ...
        #Get casting_html data from github
        from hwctool.settings.fewfunctions import update_casting_data
        update_path = self._basedir + '\\Update\\'
        update_casting_data(update_path, dir)
